...
import (
	...
	"shop/internal/service/address_service"
	"shop/pkg/app"
	"shop/pkg/constant"
	"shop/pkg/jwt"
	"shop/pkg/util"
...
// UserAddressController Address api
...
func (e *UserAddressController) GetList(c *gin.Context) {
	...
	vo, total, totalPage := addressService.GetList()
	appG.ResponsePage(http.StatusOK, constant.SUCCESS, vo, total, totalPage)
}
